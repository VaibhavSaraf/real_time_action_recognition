...
prototxt = 'G:/pystuff/Surveillance/deploy.prototxt.txt'


# The path to the pretrained Caffe model.
model = 'G:/pystuff/Surveillance/res10_300x300_ssd_iter_140000.caffemodel'


# for counting how many images detected in video
counter = 0
confidence_thr = 0.5
cap = cv2.VideoCapture('G:/pystuff/Surveillance/video.mkv')
